...
#define ASPNETCORE_EVENT_RH_MISSING_MSG                      L"Could not find the aspnetcorerh.dll at either application folder %s or dotnet path %s. Please make sure Microsoft.AspNetCore.Server.IIS package is referenced in your application."

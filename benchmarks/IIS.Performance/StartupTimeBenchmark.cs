...
namespace Microsoft.AspNetCore.Server.IIS.Performance
{
    ...
    public class StartupTimeBenchmark
    {
        ...
        public void Setup()
        {
            var deploymentParameters = new DeploymentParameters(Path.Combine(TestPathUtilities.GetSolutionRootDirectory("IISIntegration"), "test/FunctionalTests/Websites/InProcessWebSite"),
